...
namespace IntegralCalculator
{
    ...
    class SimpsonTest
    {
        ...
        [TestCase("(cos(0.3 * x + 0.8))/(0.9 + 2 * sin(0.4 * x + 0.3))", 0.2, 1, "x", 10, 0.234646)]
        [TestCase("sqrt(1.7 * x^2 + 0.5)/(1.4 + sqrt(1.2 * x + 1.3))", 0.7, 2.1, "x", 10, 0.874805)]
                ...
                string integrationVariable, int nodes, double expectedResult)
        {
            ...
            Simpson.SimpsonMethod(function);
            var result = Simpson.Result;
